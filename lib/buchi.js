...
const checkFieldInDB = (input, db_model) => __awaiter(void 0, void 0, void 0, function* () {
    const soft_delete = process.env.SOFT_DELETE;
    const finder = soft_delete ? { deleted_at: null } : {};
    finder[input.field] = input.value;
    console.log(finder);
    // const model = toPascalCase(db_table);
    const record = yield prisma[db_model].findFirst({
        where: finder
    });
    if (record) {
        console.log(record);
...
const buchi_validate = (input_1, constraints_1, ...args_1) => __awaiter(void 0, [input_1, constraints_1, ...args_1], void 0, function* (input, constraints, alias = null, fields) {
    ...
    if (input != null) {
        ...
        const rules = {
            required: {
                pass: (constraints === null || constraints === void 0 ? void 0 : constraints.required) === true ? ((input === null || input === void 0 ? void 0 : input.type) != 'file' ? ((input === null || input === void 0 ? void 0 : input.type) != "number" ? (input === null || input === void 0 ? void 0 : input.type) == 'boolean' ? typeof (input === null || input === void 0 ? void 0 : input.value) === 'boolean' : (((_a = input === null || input === void 0 ? void 0 : input.value) === null || _a === void 0 ? void 0 : _a.length) > 0) : typeof (input === null || input === void 0 ? void 0 : input.value) === 'number') : (((_b = input === null || input === void 0 ? void 0 : input.files) === null || _b === void 0 ? void 0 : _b.length) > 0)) : true,
            ...
            unique: {
                pass: (constraints === null || constraints === void 0 ? void 0 : constraints.hasOwnProperty('unique')) === true ? ((yield checkFieldInDB(input, constraints === null || constraints === void 0 ? void 0 : constraints.unique)) ? false : true) : true,
            ...
            boolean: {
                pass: (constraints === null || constraints === void 0 ? void 0 : constraints.boolean) === true ? typeof (input === null || input === void 0 ? void 0 : input.value) === "boolean" || (input === null || input === void 0 ? void 0 : input.value) === "0" || (input === null || input === void 0 ? void 0 : input.value) === "1" : true,
                message: alias === null ? getOriginalWordFromCompoundWord(input === null || input === void 0 ? void 0 : input.field) + " must be a boolean" : alias + " must be boolean"
            }
        };
        const feedback = [];
