...
const buchi_validate = (input_1, constraints_1, ...args_1) => __awaiter(void 0, [input_1, constraints_1, ...args_1], void 0, function* (input, constraints, alias = null, fields) {
    ...
    if (input != null) {
        ...
        const rules = {
            required: {
                pass: (constraints === null || constraints === void 0 ? void 0 : constraints.required) === true ? ((input === null || input === void 0 ? void 0 : input.type) != 'file' ? ((input === null || input === void 0 ? void 0 : input.type) != "number" ? ((_a = input === null || input === void 0 ? void 0 : input.value) === null || _a === void 0 ? void 0 : _a.length) > 0 : typeof (input === null || input === void 0 ? void 0 : input.value) === 'number') : (((_b = input === null || input === void 0 ? void 0 : input.files) === null || _b === void 0 ? void 0 : _b.length) > 0)) : true,
